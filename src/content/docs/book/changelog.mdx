...
In English, it sounds like _talk_. And after all, what do we use a language for? To talk. To talk to computers.
...
What is K, you might ask? Maybe, it's _kot_ — the nickname of Nikolay Durov? Or Kolya? Kitten? Kernel? Kit? Knowledge?
