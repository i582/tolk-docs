...
Here: [Tolk vs FunC: in short](../tolk-vs-func/in-short)
:::
...
<table className="cmp-func-tolk-table different-col-widths">
    ...
    <tbody>
        <tr>
            <td>
                <code>{"return 2+2;  ;; undefined function `2+2`"}</code>
            </td>
            <td>
                <code>{"return 2+2;  // 4"}</code>
            </td>
        </tr>
    </tbody>
</table>
...
<table className="cmp-func-tolk-table">
    ...
    <tbody>
        <tr>
            <td>
                <code>{"const op::increase = 0x1234;"}</code>
            </td>
            <td>
                <code>{"const OP_INCREASE = 0x1234"}</code>
            </td>
        </tr>
        <tr>
            <td>
                <code
                    dangerouslySetInnerHTML={{__html: ";; even 2%&!2 is valid<br>int 2+2 = 5;"}}
                ></code>
            </td>
            <td>
                <code
                    dangerouslySetInnerHTML={{
                        __html: "// don't do like this :)<br>var \`2+2\` = 5;",
                    }}
                ></code>
            </td>
        </tr>
...
<table className="cmp-func-tolk-table">
    ...
    <tbody>
        <tr>
            <td>
                <code>{"cell parse_data(slice cs) { }"}</code>
            </td>
            <td>
                <code>{"fun parse_data(cs: slice): cell { }"}</code>
            </td>
        </tr>
        <tr>
            <td>
                <code>{"(cell, int) load_storage() { }"}</code>
            </td>
            <td>
                <code>{"fun load_storage(): (cell, int) { }"}</code>
            </td>
        </tr>
        <tr>
            <td>
...
<table className="cmp-func-tolk-table different-col-widths">
    ...
    <tbody>
        <tr>
            ...
            <td>
                <code>{"var cs: slice = ...;"}</code>
            </td>
        </tr>
        <tr>
            <td>
                <code>{"(cell c, int n) = parse_data(cs);"}</code>
            </td>
            <td>
                <code>{"var (c: cell, n: int) = parse_data(cs);"}</code>
            </td>
        </tr>
        <tr>
            <td>
                <code>{"global int stake_at;"}</code>
            </td>
            <td>
                <code>{"global stake_at: int"}</code>
            </td>
        </tr>
    </tbody>
</table>
...
<table className="cmp-func-tolk-table">
    ...
    <tbody>
        <tr>
            <td>
                <code dangerouslySetInnerHTML={{__html: "<br>int f(cell s) inline {"}}></code>
            </td>
            <td>
                <code dangerouslySetInnerHTML={{__html: "@inline<br>fun f(s: cell): int {"}}></code>
            </td>
        </tr>
        <tr>
            <td>
                <code
                    dangerouslySetInnerHTML={{__html: "<br>() load_data() impure inline_ref {"}}
                ></code>
            </td>
            <td>
                <code dangerouslySetInnerHTML={{__html: "@inline_ref<br>fun load_data() {"}}></code>
            </td>
        </tr>
        <tr>
            <td>
...
<table className="cmp-func-tolk-table">
    ...
    <tbody>
        <tr>
            <td>
                <code>{"forall X -> tuple cons(X head, tuple tail)"}</code>
            </td>
            <td>
                <code
                    dangerouslySetInnerHTML={{
                        __html: "fun cons&lt;X&gt;(head: X, tail: tuple): tuple",
                    }}
                ></code>
            </td>
        </tr>
...
<table className="cmp-func-tolk-table">
    ...
    <tbody>
        <tr>
            <td>
                <code>{"int seqno() method_id { ... }"}</code>
            </td>
            <td>
                <code>{"get fun seqno(): int { ... }"}</code>
            </td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        <tr>
            <td>
                <code
                    dangerouslySetInnerHTML={{
                        __html: "<br>() after_code_upgrade(cont old_code) impure method_id(1666)",
                    }}
                ></code>
            </td>
            <td>
                <code
                    dangerouslySetInnerHTML={{
                        __html: "@method_id(1666)<br>fun afterCodeUpgrade(oldCode: continuation)",
                    }}
                ></code>
            </td>
        </tr>
...
var a = 10;
...
var (a, b) = (20, 30);  // error, redeclaration of a
```
...
fun send(msg: cell) {
    ...
    // solution 1: introduce a new variable
    var msgWrapped = ...;
...
<table className="cmp-func-tolk-table">
    ...
    <tbody>
        <tr>
            ...
            <td>
                <code>{'stringCrc32("...")'}</code>
            </td>
        </tr>
        <tr>
            <td>—</td>
            <td>
                <code>{'stringCrc16("...")'}</code>
            </td>
        </tr>
        <tr>
            <td>
...
<table className="cmp-func-tolk-table">
    ...
    <tbody>
        <tr>
            <td>
                <code>{"int cost = 50000000;"}</code>
            </td>
            <td>
                <code>{'val cost = ton("0.05");'}</code>
            </td>
        </tr>
        <tr>
            <td>
                <code>{"const ONE_TON = 1000000000;"}</code>
            </td>
            <td>
                <code>{'const ONE_TON = ton("1")'}</code>
            </td>
        </tr>
    </tbody>
</table>
...
someF(tupleLast(t));       // ok, T=(parameter's declared type)
...
<table className="cmp-func-tolk-table">
    ...
    <tbody>
        <tr>
            <td>
                <code>{'#include "another.fc";'}</code>
            </td>
            <td>
                <code>{'import "another"'}</code>
            </td>
        </tr>
    </tbody>
</table>
...
<table className="cmp-func-tolk-table different-col-widths">
    ...
    <tbody>
        ...
        <tr>
            <td>
                <code>{"throw_arg(arg, excNo)"}</code>
            </td>
            <td>
                <code>{"throw (excNo, arg)"}</code>
            </td>
        </tr>
        <tr>
            <td>
                <code>{"throw_unless(excNo, condition)"}</code>
            </td>
            <td>
                <code>{"assert(condition, excNo)"}</code>
            </td>
        </tr>
        <tr>
            <td>
                <code>{"throw_if(excNo, condition)"}</code>
            </td>
            <td>
                <code>{"assert(!condition, excNo)"}</code>
            </td>
...
<table className="cmp-func-tolk-table">
    ...
    <tbody>
        ...
        <tr>
            <td>
                <code>{"try { } catch (_, excNo) { }"}</code>
            </td>
            <td>
                <code>{"try { } catch(excNo) { }"}</code>
            </td>
        </tr>
        <tr>
            <td>
                <code>{"try { } catch (arg, excNo) { }"}</code>
            </td>
            <td>
                <code>{"try { } catch(excNo, arg) { }"}</code>
            </td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        <tr>
            <td>
                <code
                    dangerouslySetInnerHTML={{
                        __html: "cur_lt()<br>car(l)<br>get_balance().pair_first()<br>raw_reserve(count)<br>dict~idict_add?(...)<br>dict~udict::delete_get_max()<br>t~tpush(triple(x, y, z))<br>s.slice_bits()<br>~dump(x)<br>...",
                    }}
                ></code>
            </td>
            <td>
                <code
                    dangerouslySetInnerHTML={{
                        __html: "blockchain.logicalTime()<br>listGetHead(l)<br>contract.getOriginalBalance()<br>reserveToncoinsOnBalance(count)<br>dict.iDictSetIfNotExists(...)<br>dict.uDictDeleteLastAndGet()<br>t.push([x, y, z])<br>s.remainingBitsCount()<br>debug.print(x)<br>...",
                    }}
                ></code>
            </td>
        </tr>
...
Continue here: [Tolk vs FunC: standard library](../tolk-vs-func/stdlib).
...
<table className="cmp-func-tolk-table">
    ...
    <tbody>
        <tr>
            <td colSpan={2}>sometimes, identical:</td>
        </tr>
        <tr>
            <td>
                <code>{"0 & X = 0"}</code>
        ...
        <tr>
            <td colSpan={2}>but generally, not:</td>
        </tr>
        <tr>
            <td>
                <code>{"1 & 2 = 0"}</code>
...
<table className="cmp-func-tolk-table different-col-widths">
    ...
    <tbody>
        <tr>
            <td>
                <code className="inline">f()</code> is called always
            </td>
            <td>
                <code className="inline">f()</code> is called only if{" "}
                <code className="inline">condition</code>
            </td>
        </tr>
    </tbody>
</table>
...
<table className="cmp-func-tolk-table different-col-widths">
    ...
    <tbody>
        <tr>
            ...
            <td>
                <code className="inline">f()</code> is called only if{" "}
                <code className="inline">condition</code> is false
            </td>
        </tr>
    </tbody>
</table>
    ...
    <tbody>
        ...
        <tr>
            <td>
                <code
                    dangerouslySetInnerHTML={{
                        __html: "if (~ found?) {<br>    if (cs~load_int(32) == 0) {<br>        ...<br>    }<br>}",
                    }}
                ></code>
            </td>
            <td>
                <code
                    dangerouslySetInnerHTML={{
                        __html: "if (!found && cs.loadInt(32) == 0) {<br>    ...<br>}",
                    }}
                ></code>
            </td>
        </tr>
        <tr>
            <td>
                <code>{"ifnot (cell_null?(signatures))"}</code>
            </td>
            <td>
                <code>{"if (signatures != null)"}</code>
            </td>
        </tr>
        <tr>
            <td>
                <code>{"elseifnot (eq_checksum)"}</code>
            </td>
            <td>
                <code>{"else if (!eqChecksum)"}</code>
            </td>
        </tr>
    </tbody>
</table>
...
Continue reading on a separate page: [Mutability in Tolk](../tolk-vs-func/mutability).
...
Continue reading on a separate page: [Auto-packing to/from cells](../tolk-vs-func/pack-to-from-cells).
...
Continue reading on a separate page: [Universal createMessage](../tolk-vs-func/create-message).
