---
title: "Auto-packing to/from cells/slices/builders"
---
...
The compiler inline your functions every time packing/unpacking takes place.
...
Continue reading here: [Universal createMessage](../tolk-vs-func/create-message).
...
Continue reading here: [lazy loading, partial loading](../tolk-vs-func/lazy-loading).
