...
22. [Auto-packing](../tolk-vs-func/pack-to-from-cells) to/from cells — for any types
23. [Universal createMessage](../tolk-vs-func/create-message) to avoid manual cells composition
...
- [Tolk vs FunC: in detail](../tolk-vs-func/in-detail)
